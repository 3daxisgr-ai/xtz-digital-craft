...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "TOREO — Precision Manufacturing, Thessaloniki" },
      ...
      { property: "og:title", content: "TOREO — Precision Manufacturing, Thessaloniki" },
      { name: "twitter:title", content: "TOREO — Precision Manufacturing, Thessaloniki" },
