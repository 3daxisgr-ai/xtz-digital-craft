...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "TOREO — Rapid Prototyping, 3D Printing & CNC Manufacturing" },
      { name: "description", content: "TOREO: rapid prototyping, 3D printing services, CNC machining, fiber laser cutting and product development under one roof in Thessaloniki, Greece." },
      ...
      { property: "og:description", content: "TOREO: rapid prototyping, 3D printing services, CNC machining, fiber laser cutting and product development under one roof in Thessaloniki, Greece." },
      { name: "twitter:description", content: "TOREO: rapid prototyping, 3D printing services, CNC machining, fiber laser cutting and product development under one roof in Thessaloniki, Greece." },
          ...
          "@graph": [
            {
              ...
              description: "Rapid prototyping, 3D printing services, CNC machining, fiber laser cutting and product development under one roof.",
              areaServed: ["GR", "EU"],
              contactPoint: {
                "@type": "ContactPoint",
