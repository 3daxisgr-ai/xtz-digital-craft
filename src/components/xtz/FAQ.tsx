...
const GR: Category[] = [
  ...
  },
  {
    ...
    label: "Κοπή Laser",
    items: [
      { q: "Τι ανοχές κρατάτε;", a: "Τυπικά ±0.05 mm ανάλογα με υλικό και πάχος." },
  ...
  },
  {
    ...
    items: [
      { q: "Πόσο γρήγορα τα πρωτότυπα;", a: "Συνήθως λίγες ημέρες για 3D printed, 1–2 εβδομάδες για μεταλλικά." },
      { q: "Πόσο γρήγορη η παραγωγή;", a: "Εξαρτάται από όγκο και υλικό. Δίνουμε σαφές χρονοδιάγραμμα με κάθε προσφορά." },
    ],
  },
  {
    id: "prototyping",
