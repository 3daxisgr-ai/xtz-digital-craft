...
const GR: Category[] = [
  {
    ...
    label: "3D Εκτύπωση",
    items: [
      { q: "Η 3D εκτύπωση είναι μόνο για πρωτότυπα;", a: "Όχι. Μπορούμε να εκτυπώσουμε σχεδόν οτιδήποτε βρίσκεται εντός των διαστάσεων και των τεχνικών δυνατοτήτων των εκτυπωτών μας, από custom προϊόντα και διακοσμητικά έως λειτουργικά εξαρτήματα και μικρές παραγωγές." },
      { q: "Τι αρχεία δέχεστε;", a: ".stl, .step (.stp) ή .obj. Συμπεριλάβετε ποσότητα και υλικό." },
    ],
  },
  {
    id: "laser-cutting",
  ...
  },
  {
    ...
    label: "Υλικά",
    items: [
      { q: "Τι μέταλλα κόβετε;", a: "Χάλυβα, ανοξείδωτο, αλουμίνιο. Ορείχαλκο και Χαλκό κατόπιν συνεννόησης." },
      { q: "Ποια πολυμερή εκτυπώνετε;", a: "PLA, ABS, PETG, PA (Nylon), TPU και CF (carbon fiber)" },
    ],
  },
  {
    id: "lead-times",
    ...
    items: [
      ...
      { q: "Πόσο γρήγορη ειναι η παραγωγή;", a: "Εξαρτάται από την ποσότητα και τον όγκο. Δίνουμε σαφές χρονοδιάγραμμα με κάθε προσφορά." },
    ],
  },
  {
    id: "prototyping",
    ...
    items: [
      { q: "Πρέπει να έχω έτοιμο σχέδιο;", a: "Όχι απαραίτητα. Ξεκινάμε από ιδέα ή σκίτσο και το αναπτύσσουμε σε κατασκευή" },
    ],
  },
  {
    id: "production",
    label: "Παραγωγή",
    items: [
      { q: "Υποστηρίζετε μεγάλους όγκους;", a: "Ανάλογα με τον όγκο και τις απαιτήσεις του έργου, η παραγωγή μπορεί να πραγματοποιηθεί είτε από εμάς είτε από κάποιον αξιόπιστο συνεργάτη του δικτύου μας." },
    ],
  },
  {
    id: "pricing",
    label: "Προσφορά",
    items: [
      { q: "Πώς στέλνω προσφορά;", a: "συμπληρώνετε  τη φόρμα αιτήματος. O μηχανικός μας απαντά εντός μίας εργάσιμης." },
    ],
  },
  {
    id: "files",
