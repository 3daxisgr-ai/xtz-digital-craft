...
const gr: Dict = {
  ...
  "about.body": "Δεν είμαστε απλώς εργαστήριο laser. Δεν είμαστε απλώς εργαστήριο 3D εκτύπωσης. Είμαστε ένας ολοκληρωμένος συνεργάτης κατασκευής, που αναλαμβάνει έργα από την ιδέα έως την μαζική παραγωγή — όλα κάτω από μία στέγη.",
