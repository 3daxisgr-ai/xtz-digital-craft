...
const gr: Dict = {
  ...
  "about.title.l1": "ΟΛΟΚΛΗΡΩΜΕΝΟΣ",
  "about.title.l2": "ΣΥΝΕΡΓΑΤΗΣ",
  "about.title.l3": "ΚΑΤΑΣΚΕΥΗΣ.",
  "about.body": "Δεν είμαστε απλώς εργαστήριο laser. Δεν είμαστε απλώς εργαστήριο 3D εκτύπωσης. Είμαστε ένας ολοκληρωμένος συνεργάτης κατασκευής, που αναλαμβάνει έργα από την ιδέα έως την κλιμακούμενη παραγωγή — όλα κάτω από μία στέγη.",
  ...
  "cta.body2": "Από τον σχεδιασμό και την πρωτοτυποποίηση έως την κατασκευή και τη σειριακή παραγωγή, είμαστε στη διάθεσή σας.",
  "cta.button": "ΞΕΚΙΝΗΣΤΕ ΤΟ ΕΡΓΟ ΣΑΣ",
