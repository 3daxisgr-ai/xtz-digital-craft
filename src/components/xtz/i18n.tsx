...
const gr: Dict = {
  ...
  "portfolio.title": "​Αυτές είναι μερικές μόνο από τις δυνατότητες που προσφέρουμε.",
  ...
  "f.email": "Email",
  "f.phone": "ΤΗΛΕΦΩΝΟ *",
  "f.company": "ΕΤΑΙΡΕΙΑ (ΠΡΟΑΙΡΕΤΙΚΟ)",
  "f.service": "ΥΠΗΡΕΣΙΑ",
  "f.material": "ΥΛΙΚΟ",
  "f.stage": "ΣΤΑΔΙΟ ΕΡΓΟΥ",
  "f.dimensions": "ΔΙΑΣΤΑΣΕΙΣ",
  "f.quantity": "ΠΟΣΟΤΗΤΑ",
  "f.upload": "ΕΠΙΣΥΝΑΨΗ ΑΡΧΕΙΩΝ",
  "f.help1": "ΘΕΛΩ ΦΙΝΙΡΙΣΜΑ",
  "f.help2": "ΘΕΛΩ ΒΟΗΘΕΙΑ ΣΤΗΝ ΑΝΑΠΤΥΞΗ ΤΗΣ ΙΔΕΑΣ ΜΟΥ.",
