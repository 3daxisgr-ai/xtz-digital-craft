import designPrototypePhotoAsset from "@/assets/design-prototype-photo.png.asset.json";
import massProductionAsset from "@/assets/mass-production.png.asset.json";
...
import chapterLaserAsset from "@/assets/static-laser.png.asset.json";
const chapterLaser = chapterLaserAsset.url;
const chapterFab = chapterFabAsset.url;
const chapterPrint = chapterPrintAsset.url;
const p1 = designPrototypePhotoAsset.url;
const p3 = massProductionAsset.url;
...
const slidesGR: Slide[] = [
  ...
  { img: chapterFab, alt: "Στραντζάρισμα και συγκολλήσεις λαμαρίνας", index: "002", title: "Στραντζάρισμα & Συγκολλήσεις", category: "ΣΤΡΑΝΤΖΑ · TIG · MIG · LASER · ΠΟΝΤΑ", description: "Κάμψη, συγκόλληση και συναρμολόγηση μεταλλικών εξαρτημάτων.", tags: ["CNC Στράντζα", "Πιστοποιημένα"], slug: "sheet-metal-forming-welding" },
  { img: chapterPrint, alt: "Βιομηχανική 3D εκτύπωση για λειτουργικά εξαρτήματα", index: "003", title: "3D Εκτύπωση", category: "ΠΡΟΣΘΕΤΙΚΗ", description: "Λειτουργικά εξαρτήματα και μικρές σειρές σε μηχανικά πολυμερή.", tags: ["FDM · SLA", "Τελικής χρήσης"], slug: "3d-printing" },
