...
const slidesGR: Slide[] = [
  ...
  { img: chapterFab, alt: "Στραντζάρισμα και συγκολλήσεις λαμαρίνας", index: "002", title: "Στραντζάρισμα & Συγκολλήσεις", category: "ΣΤΡΑΝΤΖΑ · TIG · MIG", description: "Κάμψη, συγκόλληση και συναρμολόγηση μεταλλικών εξαρτημάτων.", tags: ["CNC Στράντζα", "Πιστοποιημένα"], slug: "sheet-metal-forming-welding" },
