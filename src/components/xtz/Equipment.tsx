...
function getItems(lang: "EN" | "GR"): Item[] {
  if (lang === "GR") {
    return [
      ...
      },
      {
        ...
        description:
          "Επιπλέον δυναμικότητα κοπής fiber laser για αποδοτική παραγωγή και γρήγορους χρόνους παράδοσης.",
      },
      {
        id: "press-brakes",
  ...
  return [
    ...
    },
    {
      ...
      alt: "Fiber laser cutting workshop",
      description:
        "Additional fiber laser capacity for efficient production and fast turnaround times.",
    },
    {
      id: "press-brakes",
