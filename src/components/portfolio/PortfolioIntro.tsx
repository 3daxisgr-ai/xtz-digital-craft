...
function CameraRig({ clock }: { clock: { t: number } }) {
  ...
  const smoothed = useMemo(() => new THREE.Vector3(7.3, 2.5, 4.6), []);
  ...
  useFrame((_, delta) => {
    ...
    const keys = [
      { t: 0.0, r: 9.0, a: 0.55, e: 0.2 },
      { t: 1.0, r: 9.9, a: 0.78, e: 0.28 },
      { t: 2.2, r: 15.6, a: 1.35, e: 0.52 },
      { t: 3.2, r: 16.3, a: 1.85, e: 0.58 },
      { t: 4.2, r: 15.5, a: 2.4, e: 0.48 },
      { t: 5.3, r: 12.0, a: 2.9, e: 0.4 },
      { t: 6.4, r: 11.2, a: 3.3, e: 0.34 },
    ];
    let k0 = keys[0];
  ...
  return (
    ...
    >
      <Canvas
        ...
        dpr={[1, 2]}
        frameloop="always"
        camera={{ position: [7.3, 2.5, 4.6], fov: 40, near: 0.1, far: 200 }}
        gl={{
          antialias: true,
