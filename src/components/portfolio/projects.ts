...
export const PROJECTS: Project[] = [
  {
    ...
    title: "Column base",
    fileKind: "STL",
    fileName: "BASI_KOLONAS_PANO_V2.stl",
    summary: "Load-bearing 3D printed structural base component.",
    description:
      "A structural column base component optimized for 3D printing. This part was printed in silver ABS for high durability and structural integrity while maintaining the complex internal geometries required for mounting.",
    ...
    featured: true,
    status: "Delivered",
    tags: ["3d printing", "structural", "ABS"],
    accent: "#5aa9ff",
    stage: 8,
  ...
  },
  {
    ...
    tolerance: "±0.2 mm",
    finish: "Powder coat RAL 9005",
    year: 2025,
    views: 2410,
    featured: true,
    status: "Delivered",
    tags: ["flat pattern", "bending", "single setup"],
    accent: "#a78bfa",
    stage: 8,
    parts: [
      // Web: 500 mm × 129.3 mm × 3 mm (scene units = 100 mm)
      { name: "Web (129.3 mm)", kind: "box", args: [5.0, 0.03, 1.293], position: [0, 0, 0], explode: [0, -0.6, -0.8], color: STEEL, metalness: 0.86, roughness: 0.34 },
      // Flange: 49.3 mm folded 90° at the bend line
      { name: "Flange (49.3 mm)", kind: "box", args: [5.0, 0.03, 0.493], position: [0, 0.2465, 0.6465], rotation: [Math.PI / 2, 0, 0], explode: [0, 0.9, 1.0], color: DARK_STEEL, metalness: 0.86, roughness: 0.34 },
      // Bend radius relief along the fold line
      { name: "Bend radius", kind: "cylinder", args: [0.03, 0.03, 5.0, 24], position: [0, 0.015, 0.6465], rotation: [0, 0, Math.PI / 2], explode: [0, 0.4, 0.4], color: BRASS, metalness: 0.9, roughness: 0.26 },
    ],
  },
